...
8) Run predict_image.py for testing on images of all 3 person and one unknown person.
   To change test image chane line number 11 (img_path='../test_data/yl.jpeg') from test data folder pass any image
   
   
Fast Usage with outtraining
----------------------------
Run predict_image.py . Test image YanLecunn
